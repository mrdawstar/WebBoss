...
const AboutSection = () => {
  ...
  return (
    <section className="section-padding relative z-10" ref={ref} id="about">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="glass-card rounded-3xl overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-500">
                  <div className="aspect-[4/5] relative overflow-hidden">
                    <img 
                      src="/avatar.PNG"
                      alt="Dawid - Web Developer" 
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 via-black/60 to-transparent">
                      ...
                      <h3 className="text-2xl font-bold text-white">Dawid</h3>
                      <p className="text-white/80 text-sm">Web Developer & Designer</p>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-6">
                  Tworzę <span className="font-semibold text-primary">nowoczesne strony</span> które 
                  przyciągają uwagę i konwertują.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <p className="text-foreground/80">
                  Specjalizuję się w tworzeniu szybkich, responsywnych stron internetowych 
                  z naciskiem na user experience i design.
                </p>
                <p className="text-foreground/80">
                  Wierzę w połączenie solidnej technologii z estetyką, która działa.
                </p>
              </div>
              ...
              {/* Skills */}
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-4">Umiejętności</h3>
              ...
              <div className="pt-4">
                ...
                <p className="text-sm text-muted-foreground mt-4 italic">
                  "Profesjonalne podejście i zaangażowanie w każdy projekt"
                </p>
              </div>
            </motion.div>
          </div>
